...
/alcohol-duty-account/bta-tile-data/AP0000000001
...
| approvalStatus                        | The current approval status of the user(Approved, Insolvent, DeRegistered, Revoked, SmallCiderProducer) | Enum       | Optional           | Conditional based on the hasSubscriptionSummaryError                               |
